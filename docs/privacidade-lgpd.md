...
Pagar.me segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Pagar.me (Stone)** | BR | payments gateway API (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pagarme@mcp.ai](mailto:pagarme@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
